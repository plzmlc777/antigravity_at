...
# Paths
current_db_url = "postgresql://antigravity_user:antigravity_password@localhost/antigravity_db"
# backup is irrelevant for this check script if we just check PG
