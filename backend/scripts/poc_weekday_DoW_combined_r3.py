#!/usr/bin/env python3
"""Phase R-3 robustness for weekday_DoW_combined (n=200 perm test)."""
...
from scripts.poc_weekday_DoW_combined import (  # noqa: E402
    PARADIGM, OUT_DIR, load_close_1d, load_premium_close_1d, simulate,
)

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
log = logging.getLogger("poc_weekday_DoW_combined_r3")
...
def main() -> int:
    ...
    p.add_argument("--symbols", nargs="+",
                   default=["DOGEUSDT", "SOLUSDT", "LDOUSDT", "AVAXUSDT", "UNIUSDT"])
    ...
    for sym in args.symbols:
        try:
            ...
            tag = f"r3_{sym}_z{args.entry_z}_h{args.hold_days}"
