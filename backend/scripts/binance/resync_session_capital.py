...
적용 이력:
  2026-08-08 15:42  실계좌 8세션 (+137.02) — 드라이버 직접청산이 갱신을 안 함
  2026-08-08 16:57  나머지 27세션 — 원인 3가지로 갈렸다
      A 미거래 세션 7건: current_capital 이 초기값으로 세팅된 적 없이 0
      B 갱신 전무 4건 : dead-column 시절 세션 (체결은 있는데 cc=0)
      C 부분갱신 16건 : 마지막 체결이 반영되기 직전 값에서 멈춤. 전부
        2026-07-27 09:23 고아 포지션 수동 청산 시각이다 — execution 행만
        기록하고 파생 컬럼을 갱신하지 않은, 실계좌와 동일한 원인.
        (부호가 세션마다 갈린 건 마지막 체결의 pnl 부호가 달랐기 때문)
  검증: 전체 46세션 어긋남 0.
