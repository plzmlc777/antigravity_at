...
SEEDS = {
    ...
    #   2026-09-08 22:47 균형저울 **되돌림** — 대표님 지시. 가동 28분.
    #     선정 근거였던 7일 기울기가 t +0.26(8갈래 중 |t|>2 는 UTC01 하나뿐)
    #     이고, 같은 창의 총손익은 8갈래 중 7위였다. 왕복 비용 -1.01 USDT.
    #   현재 배정된 갈래 없음 — 현금 대기.
    #   2026-09-09 09:17 버팀저울(imp3ns · 무손절) 배정 → 09:52 **철회**.
    #     무손절 근거였던 손절 격자가 슬롯 회전을 안 세어 편향돼 있었다.
    #     원장 92건은 손절 35건이 자리를 비운 결과이고, 무손절이면 동시보유
    #     8이 필요해 3슬롯으로 불가능하다 — 진입 42건이 차단된다(§31).
    #     한 건도 열기 전에 되돌렸으므로 손실 0.
    #   2026-09-09 09:52 **탄성저울**(imp3s · 손절 5%) 재가동. 규칙이 09-07 판본과
    #     같으므로 이름·경로·원장을 그대로 이어 쓴다(자본 지수 0.9890 · 누적 6).
    15: ("탄성저울 (1군)", 400.00, "2026-09-05", 0.0),
}
