#!/usr/bin/env python3
"""Phase R-3 robustness for premium_index_zscore (n=200 perm test).

Permutation strategy: shuffle daily premium series, keep close (price) intact.
Real signal lies in the joint timing of premium z-extreme and subsequent
price direction. Shuffling premium destroys time-dependence of premium
while preserving price autocorrelation. If real_alpha exceeds shuffled
alphas with perm_p ≤ 0.05, signal is robust.
...
def main() -> int:
    ...
    p.add_argument("--symbols", nargs="+",
                   default=["DOGEUSDT", "LDOUSDT", "SOLUSDT", "AVAXUSDT"])
