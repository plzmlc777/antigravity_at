"""Grid search v7 (3rd batch 14 symbols) — 14 NEW Binance symbols, all source combos (S/T/O/E/P/V/M/C).
...
# 14 NEW symbols (3rd batch)
SYMBOLS = ["DOTUSDT", "TONUSDT", "AAVEUSDT", "MKRUSDT", "LDOUSDT", "WLDUSDT",
           "JUPUSDT", "ICPUSDT", "ALGOUSDT", "ETCUSDT", "STXUSDT", "IMXUSDT",
           "FETUSDT", "GRTUSDT"]
...
def main():
    ...
    print(f"Grid v7 — 14 NEW Binance symbols. {n_total} conditions.")
    ...
    out_path = ROOT / "runs" / "binance_grid_search_v7.csv"
