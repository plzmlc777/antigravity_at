#!/usr/bin/env python3
"""Phase R-3 robustness for premium_velocity_zscore (n=200 perm test).

Permutation: shuffle premium series. Tests if velocity timing predicts
price moves vs random.
"""
...
from scripts.poc_premium_velocity_zscore import (  # noqa: E402
    PARADIGM, OUT_DIR, load_close_1d, load_premium_close_1d, simulate,
)

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
log = logging.getLogger("poc_premium_velocity_zscore_r3")
...
def main() -> int:
    ...
    p.add_argument("--symbols", nargs="+",
                   default=["AVAXUSDT", "UNIUSDT", "SOLUSDT", "ETCUSDT"])
