#!/usr/bin/env python3
"""Phase R-3 robustness for garman_klass_vol_premium (n=200 perm test)."""
...
from scripts.poc_garman_klass_vol_premium import (  # noqa: E402
    PARADIGM, OUT_DIR, load_close_1d, load_premium_ohlc, simulate,
)

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
log = logging.getLogger("poc_garman_klass_vol_premium_r3")
...
def main() -> int:
    ...
    p.add_argument("--symbols", nargs="+", default=["SOLUSDT", "UNIUSDT", "LDOUSDT"])
