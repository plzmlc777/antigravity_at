"""Grid search v6 — 14 NEW Binance symbols, all source combos (S/T/O/E/P/V/M/C).
...
# 14 NEW symbols
SYMBOLS = ["TRXUSDT", "TAOUSDT", "ORDIUSDT", "1000PEPEUSDT", "ATOMUSDT", "TIAUSDT",
           "SUIUSDT", "INJUSDT", "ARBUSDT", "APTUSDT", "UNIUSDT", "ENAUSDT",
           "OPUSDT", "PYTHUSDT"]
...
def main():
    ...
    print(f"Grid v6 — 14 NEW Binance symbols. {n_total} conditions.")
    ...
    out_path = ROOT / "runs" / "binance_grid_search_v6.csv"
