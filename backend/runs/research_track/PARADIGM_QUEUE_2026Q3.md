...
| (open) | 새 mechanism candidate 발의 필요 | — | — | Q3 §6.2 lessons #8-#20 회피. **Cross-asset corr (74-77) + geometric path metrics (78) + funding × OI joint squeeze (73, 79) family 폐기 확정**. OI×premium 5m joint **event** 차원도 paradigm 80 (level) + 82 (velocity × direction at pre-funding event) 둘 다 broad-falsified로 family extension caution. cross-symbol rolling beta breakdown은 narrow scope (3 syms cluster) 외 falsified (81, lesson #20). microstructure novel non-OI-velocity / non-taker / non-LSR / non-OI×premium-joint / non-rolling-beta 차원 또는 OHLCV-only non-corr/non-vol-regime/non-skewness/non-path/non-vwap/non-ref-price 차원 brainstorming 필요. 신규 feature transform (premium acceleration / OI dispersion across exchanges / mark-index separate legs 등) 만 OI×premium 도메인에서 허용. **52 R-1 graveyards / 5% PASS rate / 4 retired families** 메타 상태에서 frontier 극소화 인정. /new-paradigm-frontier 첫 dispatch도 BROAD_FALSIFIED — 단순 z/velocity/divergence/event-anchored single-signal paradigm 공간 사실상 소진 재확인. |
