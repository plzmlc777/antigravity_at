...
| (open) | 새 mechanism candidate 발의 필요 | — | — | Q3 §6.2 lessons #8-#18 회피. **Cross-asset corr (74-77) + geometric path metrics (78) + funding × OI joint squeeze (73, 79) family 폐기 확정**. premium 5m 백필 후 #4 oi_premium_5m_decoupling 또는 microstructure novel non-OI-velocity / non-taker 차원 또는 OHLCV-only non-corr/non-vol-regime/non-skewness/non-path 차원 brainstorming 필요. |
