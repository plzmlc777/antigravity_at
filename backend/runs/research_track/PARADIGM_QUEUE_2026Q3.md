...
| (open) | 새 mechanism candidate 발의 필요 | — | — | Q3 §6.2 lessons #8-#19 회피. **Cross-asset corr (74-77) + geometric path metrics (78) + funding × OI joint squeeze (73, 79) family 폐기 확정**. OI×premium 5m joint z-score level 변형도 폐기 (80, lesson #19). microstructure novel non-OI-velocity / non-taker / non-LSR / non-OI×premium-joint 차원 또는 OHLCV-only non-corr/non-vol-regime/non-skewness/non-path 차원 brainstorming 필요. 신규 feature transform (premium acceleration / OI dispersion across exchanges / mark-index separate legs 등) 만 OI×premium 도메인에서 허용. |
