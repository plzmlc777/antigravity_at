"""
MetaPaperRunner — Phase 5 wire-in of the meta-strategy MoE plan.

Each cycle:
  1. fetch 1m feed since session.start_date
...
class MetaPaperSession:
    ...
    meta_fallback_strategy: str = "s40_vwap_atr_1m5m"
...
class MetaPaperRunner:
    def __init__(
        self,
        engine: Engine,
        registry: Dict[str, Type[KrStrategyBase]],
    ...
    async def run_cycle(self, session: MetaPaperSession) -> Dict[str, Any]:
        ...
        if chosen is None:
            ...
            engine_bt = KrBacktestEngine(cls, exchange_name="Kiwoom")
