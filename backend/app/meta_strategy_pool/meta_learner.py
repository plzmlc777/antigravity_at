"""
Universal Meta-Learner — Phase A.

KR/Crypto meta_learner의 architecture-identical 통합본. FEATURE_NAMES만
unified env_encoder에서 import하여 importance 이름이 일관됨.

기존 KR/Crypto meta_learner.py와 학습 로직 동일.
"""
