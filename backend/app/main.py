...
app = FastAPI(title="AutoTrading Agent API", version="0.9.2.8", description="Backend API for AI-driven Auto Trading System", lifespan=lifespan)
...
@app.get("/")
async def root():
    return {"message": "Welcome to AutoTrading Agent API v0.9.2.8", "version": "0.9.2.8", "status": "running"}
