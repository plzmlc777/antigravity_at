...
app = FastAPI(title="AutoTrading Agent API", version="0.9.3.1", description="Backend API for AI-driven Auto Trading System", lifespan=lifespan)
...
@app.get("/")
async def root():
    return {"message": "Welcome to AutoTrading Agent API v0.9.2.9", "version": "0.9.2.9", "status": "running"}
