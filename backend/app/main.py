...
app = FastAPI(title="AutoTrading Agent API", version="0.9.4.7", description="Backend API for AI-driven Auto Trading System", lifespan=lifespan)
...
@app.get("/")
async def root():
    return {"message": "AntiGravity Crypto/Stock Auto-Trading Backend v0.9.4.7 Running", "version": "0.9.4.7", "status": "running"}
