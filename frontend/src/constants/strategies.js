...
export const PARAM_DEFINITIONS = [
    ...
    { key: 'trailing_start_percent', label: 'Trail Start (Price%)', type: 'number', defaultValue: 1, defaultOptRange: "0.5, 1.0, 1.5", placeholder: '3, 5' },
    { key: 'trailing_stop_percent', label: 'Trail Stop (Price%)', type: 'number', defaultValue: 0, defaultOptRange: "0, 0.2, 0.5", placeholder: '1, 2' },
    {
        key: 'stop_time',
        label: 'Stop Time',
        type: 'select',
