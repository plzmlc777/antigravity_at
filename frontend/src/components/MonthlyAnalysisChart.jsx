...
/**
 * Monthly Analysis Chart - Shared component for Strategy Stability visualization
 * Used by both StrategyView (Rank Tab) and IntegratedAnalysis (Integrated Tab)
 *
 * @param {Array} decileStats - Array of monthly stats: [{block: "24-01", count: 12, win_rate: 60, total_pnl: 5.2}, ...]
 * @param {string} title - Chart title (default: "Strategy Stability (Monthly Analysis)")
 */
const MonthlyAnalysisChart = ({ decileStats, title = "Strategy Stability (Monthly Analysis)" }) => {
    if (!decileStats || decileStats.length === 0) {
        return null;
    }
        ...
        <div className="mt-4 pt-4 border-t border-white/10">
            ...
            <div className="h-[200px] w-full bg-black/20 rounded-lg p-2">
                <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={decileStats} margin={{ bottom: 60, left: 0, right: 0 }}>
