    ...
    return (
        <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid gap-4">
                ...
                {accounts.map(acc => (
                    <div key={acc.id} className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-xl hover:border-white/20 transition-colors">
                        <div className="flex items-center gap-4">
                            <div className="h-10 w-10 flex items-center justify-center bg-blue-500/20 text-blue-400 rounded-lg">
                                {acc.exchange_name[0]}
                            </div>
                            <div>
